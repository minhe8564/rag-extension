package com.ssafy.hebees.domain.user.controller;

import com.ssafy.hebees.domain.user.dto.request.UserRoleUpsertRequest;
import com.ssafy.hebees.domain.user.dto.response.UserRoleCreateResponse;
import com.ssafy.hebees.domain.user.dto.response.UserRoleResponse;
import com.ssafy.hebees.domain.user.entity.UserRole;
import com.ssafy.hebees.domain.user.service.UserRoleService;
import com.ssafy.hebees.global.dto.ListResponse;
